...
(function () {
  ...
  async function load() {
    ...
    try {
      ...
      if (img) {
        const src =
          (typeof coin.image === "string" ? coin.image : null) ||
          (coin.image && (coin.image.large || coin.image.small || coin.image.thumb)) ||
          "";
        img.src = src || (NS.ui && NS.ui.logoFallback ? NS.ui.logoFallback(coin.symbol, coin.name) : "");
        img.alt = coin.symbol || "";
      }

...
(function () {
  ...
  const dict = {
    en: {
      ...
      "setup-title": "CoinMarketCap data not loaded yet",
      "setup-body": "To show real data on GitHub Pages, add Actions secret CMC_PRO_API_KEY and run workflow \"Update market data\". After it finishes, reload the page.",
      "setup-open-readme": "Open setup instructions",
    ...
    ru: {
      ...
      "setup-title": "Данные CoinMarketCap ещё не загружены",
      "setup-body": "Чтобы на GitHub Pages появились реальные данные, добавь секрет Actions CMC_PRO_API_KEY и запусти workflow \"Update market data\". После успешного запуска обнови страницу.",
      "setup-open-readme": "Открыть инструкцию",

...
(function () {
  ...
  const dict = {
    en: {
      ...
      "setup-title": "CryptoRank data not loaded yet",
      "setup-body": "To show real data on GitHub Pages, add Actions secret CRYPTORANK_API_KEY and run workflow \"Update market data\". After it finishes, reload the page.",
    ...
    ru: {
      ...
      "setup-title": "Данные CryptoRank ещё не загружены",
      "setup-body": "Чтобы на GitHub Pages появились реальные данные, добавь секрет Actions CRYPTORANK_API_KEY и запусти workflow \"Update market data\". После успешного запуска обнови страницу.",
